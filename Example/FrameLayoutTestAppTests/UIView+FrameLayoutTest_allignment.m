...
- (void)testAlignViewsVertically_verticalDistance {
    ...
    CGRect thirdViewFrame = [self.viewsAndSpacingsArray[5] frame];
...
- (void)testAlignViewsVertically_horizontalCentering {
    ...
    CGFloat totalHeight = [self.superView pl_alignViewsVertically:self.viewsAndSpacingsArray additionallyAligningTo:NSLayoutAttributeCenterX
                                                       withMargin:margin];

    UIView *firstView = self.viewsAndSpacingsArray[1];
    UIView *secondView = self.viewsAndSpacingsArray[3];
    UIView *thirdView = self.viewsAndSpacingsArray[5];
...
- (void)testAlignViewsVertically_horizontalAlignLeft {
    ...
    CGFloat totalHeight = [self.superView pl_alignViewsVertically:self.viewsAndSpacingsArray additionallyAligningTo:NSLayoutAttributeLeft
                                                       withMargin:margin];
...
- (void)testAlignViewsVertically_horizontalAlignRight {
    ...
    CGFloat totalHeight = [self.superView pl_alignViewsVertically:self.viewsAndSpacingsArray additionallyAligningTo:NSLayoutAttributeRight
                                                       withMargin:margin];
...
- (void)testAlignViewsHorizontally_verticalAlignCenter {
    ...
    CGFloat totalWidth = [self.superView pl_alignViewsHorizontally:self.viewsAndSpacingsArray
                                            additionallyAligningTo:NSLayoutAttributeCenterY withMargin:margin];
...
- (void)testAlignViewsHorizontally_verticalAlignTop {
    ...
    CGFloat totalWidth = [self.superView pl_alignViewsHorizontally:self.viewsAndSpacingsArray additionallyAligningTo:NSLayoutAttributeTop
                                                        withMargin:margin];
...
- (void)testAlignViewsHorizontally_verticalAlignBottom {
    ...
    CGFloat totalWidth = [self.superView pl_alignViewsHorizontally:self.viewsAndSpacingsArray additionallyAligningTo:NSLayoutAttributeBottom
                                                        withMargin:margin];
